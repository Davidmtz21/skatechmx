...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Su cesta ha sido actualizada');</script>";
		}
	}
...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Se ha actualizado la dirección de facturación');</script>";
		}
	}


// Codigo para actualizar la direccion de envio
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('Se ha actualizado la dirección de envío');</script>";
		}
	}
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Cargo de envio</th>
					<th class="cart-total last-item">Total general</th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input type="submit" name="submit" value="Actualizar la cesta de la compra" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Mx"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Mx"." ".$row['shippingCharge']; ?>.00</span></td>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Direccion de facturacion<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Estado de facturacion <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Ciudad de facturacion <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Codigo postal de facturacion <span>*</span></label>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Direccion de facturacion</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Codigo postal de expedicion <span>*</span></label>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">PASAR POR LA CAJA</button>
