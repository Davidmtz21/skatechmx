	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
					echo "<script>alert('El producto se ha añadido a la cesta')</script>";
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									Mx. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount">Mx.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Ingresar al carrito</button></a>
								<?php } else {?>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Gastos de envio :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">Mx. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">Mx.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">REVISIÓN</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Opiniones de los clientes</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Cantidad :</b>  <?php echo htmlentities($rvw['quality']);?> Star</div>
													<div class="text"><b>Precio :</b>  <?php echo htmlentities($rvw['price']);?> Star</div>
										...
										<div class="product-add-review">
											<h4 class="title">Escriba su propio comentario</h4>
											...
											<div class="review-form">
												<div class="form-container">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Consulte <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">ENVIAR REVISIÓN</button>
														</div><!-- /.action -->
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Mx.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">Mx.
