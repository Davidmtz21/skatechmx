...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="Id. de correo electrónico o nº de contacto no válidos";
exit();
}
}
...
<html lang="en">
	<head>
	    ...
	    <title>SkatechMx | Olvide mi password</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Olvide mi Password</li>
			</ul>
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">Olvide mi password</h4>
...
?>
		...
		<div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Direccion email <span>*</span></label>
		    <input type="email" name="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" required >
		</div>
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Numero de Contacto<span>*</span></label>
