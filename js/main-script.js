...
$(document).ready(function(){
	...
	$('#newsletter').submit(function(e){
		...
		if($(this).find('input[type="text"]').val() == ''){
			...
			if($(this).find('span.error').length==0){
				$(this).append('<span class="error">Por favor, introduzca su dirección de correo electrónico</span>');
			}else{
				$(this).find('span.error').text('Por favor, introduzca su dirección de correo electrónico');
			}
	...
	$('#contact-form').submit(function(e){
		...
		if(error == true){
			...
			if($(this).find('span.error').length==0){
				$(this).append('<span class="error">Por favor, rellene todos los campos</span>');
			}else{
				$(this).find('span.error').text('Por favor, rellene todos los campos');
			}
