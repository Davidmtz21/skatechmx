...
{?>
									...
									<strong>Super!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="controls">
<input type="text" placeholder="Introduzca el nombre de la categoría"  name="category" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Estas seguro de que quieres borrar?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
