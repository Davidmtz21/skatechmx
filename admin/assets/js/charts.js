var Charts = function () {
    ...
    var runCharts = function () {
        ...
        //Tiempo real 
        // Usamos una fuente de datos en línea en el ejemplo, normalmente los datos serían
        // se obtienen de un servidor
        var data = [],
            totalPoints = 300;
        ...
        function getRandomData() {
            ...
            // Comprime los valores y generados con los valores x
            var res = [];
        ...
        // Configurar el widget de control
        ...
        var plot = $.plot("#placeholder4", [getRandomData()], {
            series: {
                shadowSize: 0 // Dibujar es más rápido sin sombras
            },
            yaxis: {
                min: 0,
                max: 100
        ...
        placeholder.append("<div style='position:absolute;left:" + (o.left + 4) + "px;top:" + o.top + "px;color:#666;font-size:smaller'>Calentamiento</div>");
        o = plot_annotation.pointOffset({
            x: 8,
            y: -1.2
        });
        placeholder.append("<div style='position:absolute;left:" + (o.left + 4) + "px;top:" + o.top + "px;color:#666;font-size:smaller'>Medidas reales</div>");
