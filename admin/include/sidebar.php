...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="insert-product.php"><i class="menu-icon icon-paste"></i>Insertar Productos </a></li>
                                <li><a href="manage-products.php"><i class="menu-icon icon-table"></i>Administrar Productos </a></li>
                        
                            </ul><!--/.widget-nav-->

						<ul class="widget widget-menu unstyled">
							<li><a href="user-logs.php"><i class="menu-icon icon-tasks"></i>Iniciar sesion de usuario </a></li>
