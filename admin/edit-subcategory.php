...
<head>
	...
	<title>Admin| Editor SubCategory</title>
...
<div class="controls">
<input type="text" placeholder="Introduzca el nombre de la categoría"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
