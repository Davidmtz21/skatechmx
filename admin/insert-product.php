...
<head>
	...
	<title>Admin| Inserta Producto</title>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Introduzca el nombre de la empresa" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Introduzca los gastos de envío del producto" class="span8 tip" required>
</div>
</div>
