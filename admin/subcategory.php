...
<div class="control-group">
<label class="control-label" for="basicinput">Nombre de la subcategoría</label>
<div class="controls">
<input type="text" placeholder="Introduzca el nombre de la subcategoría"  name="subcategory" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Estás seguro de que quieres borrar?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
