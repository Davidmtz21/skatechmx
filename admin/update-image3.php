					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar producto Imagen 3</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Actual Producto Imagen1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nuevo Producto Imagen3</label>
<div class="controls">
