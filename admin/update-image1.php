...
<head>
	...
	<title>Admin| Actualizar la imagen del producto</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar Producto Imagen 1</h3>
							</div>
...
{?>
									...
									<strong>Bien!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen del producto actual</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nuevo Producto Image1</label>
<div class="controls">
