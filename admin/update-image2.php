					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar Producto Imagen 2</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen1 del producto actual</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva Producto Imagen2</label>
<div class="controls">
