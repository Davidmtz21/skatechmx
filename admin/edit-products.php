...
{?>
									...
									<strong>Oh vaya!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="controls">
<input type="text"    name="productName"  placeholder=" Introduzca el nombre del producto " value="<?php echo htmlentities($row['productName']);?>" class="span8 tip" >
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Empresa Producto</label>
<div class="controls">
<input type="text"    name="productCompany"  placeholder=" Introduzca el nombre de la empresa " value="<?php echo htmlentities($row['productCompany']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Precio del Producto antes del descuento</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Introduzca el precio del producto" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Introduzca el precio del producto" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Cargos de envio del producto</label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Introduzca los gastos de envío del producto" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Producto Imagen1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Producto Imagen2</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Producto Imagen3</label>
<div class="controls">
...
<?php } ?>
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn">Actualización</button>
											</div>
										</div>
									</form>
							</div>
