...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Busca aqui" name="product" required="required" />
...
<!-- ============================================================= Fin del area de busqueda ============================================================= -->				</div><!-- /.top-search-holder -->
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">Mx.<?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>Mx.<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
...
<!-- ============================================================= Final carrito de compras============================================================= -->				</div><!-- /.top-cart-row -->
			</div><!-- /.row -->
