		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total item">Gran total</th>
...
?>
				<tr>
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Orden de seguimiento">
 Rastrear</td>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">El ID de pedido o el ID de correo electronico registrado no son validos.</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
