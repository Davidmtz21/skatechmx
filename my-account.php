...
<div class="form-group">
					    <label class="info-title" for="Current Password">Password actual<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="New Password">Nuevo Password <span>*</span></label>
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">Confirmar Password <span>*</span></label>
